...
% Normalize the mean-reduced spectrogram by it's mean noise values.
sp_whiten = abs((sp_whiten./(mu*ones(1,parm.NumTimeBins))).')';


%% Optional: Whiten in frequency 
if parm.whiten == 2 
    ...
    % Normalize the spectrogram over it's time bin mean noise values
